...
(function() {
    'use strict';
    console.log("[ECLIPSE] Inicializando Versão Iframe...");

    
    window.openEclipseMenu = function() {
        console.log("[ECLIPSE] Abrindo menu via Iframe isolado...");
        var wrap = document.getElementById('eclipse-iframe-wrap');
        if (wrap) wrap.remove();
        
        wrap = document.createElement('div');
        wrap.id = 'eclipse-iframe-wrap';
        wrap.style.cssText = "position:fixed; inset:0; z-index:2147483647; display:flex; align-items:center; justify-content:center; background:rgba(0,0,0,0.8); pointer-events:auto;";
