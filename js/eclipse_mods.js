...
(function() {
    'use strict';
    console.log("[ECLIPSE] Inicializando Versão Base64...");

    
    window.openEclipseMenu = function() {
        console.log("[ECLIPSE] Descodificando e abrindo menu original...");
        ...
        setTimeout(function() {
            ...
            console.log("[ECLIPSE] Menu original restaurado com sucesso.");
        }, 200);
    };
